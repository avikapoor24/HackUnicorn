...
const SignUpPage = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen text-black">
      <h1 className="text-5xl font-bold text-white mb-4">Signup</h1>
      <h1
        className="text-5xl font-bold cursor-pointer text-white mb-4"
        
      >
        Already a user?
      </h1>
      <h1
        className="text-9xl font-bold cursor-pointer text-red-600 mb-4"
