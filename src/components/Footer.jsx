  ...
  return (
    <div className="max-w-[1240px] h-[28vh] mx-auto grid lg:grid-cols-3 gap-10 relative  text-[#525252] mt-auto  pt-7">
      <div className="justify-center ">
        <img
          className="h-12 w-12 inline-block relative bottom-2 right-2"
          src={ab}
          alt="LogoImg"
        ></img>
        <a
          href="/src/components/Home.jsx"
          className=" text-4xl  text-[#ffffff] inline-block"
        >
          FINOVATECH.IO
        </a>
      ...
      <div className="lg:col-span-2 flex justify-between mt-6">
        ...
        <div className="relative left-[100px]">
          <h2 className="font-medium text-3xl text-[#FE6262]">
            Subscribe to Our Newsletter
          </h2>
          <Newsletter className="relative bottom-[20px]" />
        </div>
        <div>
          <h2 className="font-medium text-3xl flex text-[#FE6262]">
            Follow Us On:
          </h2>
          <ul className="text-[#a09f9f] flex justify-between md:w-[75%] my-6 ">
            <li>
              <FaInstagram size={30} radius={30} />
            </li>
            <li>
              <FaTwitterSquare size={30} radius={30} />
            </li>
            <li>
              <FaGithubSquare size={30} radius={30} />
            </li>
            <li>
              <FaDribbbleSquare size={30} radius={30} />
            </li>
          </ul>
        </div>
      </div>
