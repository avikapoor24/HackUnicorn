  ...
  return (
    ...
    >
      <div className="h-full flex flex-col justify-start pt-20 px-4 ">
        <h1 className="text-8xl  text-white px-40 mt-[90px]">
          Dive Into the New Age of{" "}
        </h1>
        <h1 className="text-8xl  text-white px-40"> Accelerated Analytics</h1>

        <h2 className="text-5xl  text-white px-40 pt-11">Our Services</h2>
      </div>
      <div
        className="h-[70vh] bg-center bg-cover bg-no-repeat"
        style={{
      ...
      ></div>
      <div
        className="h-[77vh] bg-center bg-cover bg-no-repeat"
        style={{
