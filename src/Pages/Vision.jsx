...
const Vision = () => {
  return (
    <div className=" m-3 Heading font-roboto text-2xl sm:text-3xl md:text-5xl relative top-20 text-white text-center py-10">
      ...
      <p className="mt-10">At Finovatech, our vision is to revolutionize the way people manage their finances. We strive to provide innovative solutions that simplify the complex world of finance, empowering individuals and businesses to take control of their financial future. Our ultimate goal is to help our clients achieve financial success and security, one transaction at a time.</p>
      ...
      {/* <div>
        <div >
          <h2>Your Vision Title</h2>
          <p>Your vision description goes here.</p>
        </div>
      </div> */}
    </div>
